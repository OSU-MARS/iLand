...
Write-Trajectory -Trajectory $elliott -IndividualTreeFile ([System.IO.Path]::Combine($unitTestPath, "..\\TestResults\\Elliott individual tree trajectories.feather")) -ResourceUnitFile ([System.IO.Path]::Combine($unitTestPath, "..\\TestResults\\Elliott resource unit trajectories.feather")) -StandFile ([System.IO.Path]::Combine($unitTestPath, "..\\TestResults\\Elliott stand trajectories.feather"))
