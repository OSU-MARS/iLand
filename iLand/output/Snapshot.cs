...
namespace iLand.output
{
    ...
    {
        private Dictionary<int, ResourceUnit> mRUHash;

        public Snapshot()
        {
        }

        private bool openDatabase(string file_name, bool read)
        {
            ...
            if (!read)
            {
                SqliteConnection db = GlobalSettings.instance().dbsnapshot();
                ...
                createSnag.ExecuteNonQuery();
                transaction.Commit();
                Debug.WriteLine("Snapshot - tables created. Database " + file_name);
            }
            return true;
        }
        ...
        public bool createSnapshot(string file_name)
        {
            ...
            Grid<ResourceUnit> ruGrid = GlobalSettings.instance().model().RUgrid();
            ...
            string grid_text = Grid.gridToESRIRaster(index_grid);
        ...
        public bool loadSnapshot(string file_name)
        {
            ...
            else
            {
                ...
                if ((to.X % Constant.cRUSize) != 0.0 || (to.Y % Constant.cRUSize) != 0.0)
                {
                ...
                {
                    ResourceUnit ru = rugrid.constValueAtIndex(i);
                    if (ru != null && ru.index() > -1)
                    {
                        int value = (int)grid.value(rugrid.cellCenterPoint(i));
                        if (value > -1)
                        {
                            mRUHash[value] = ru;
                        }
        ...
        {
            // Check database
            SqliteConnection db = GlobalSettings.instance().dbsnapshotstand();
            ...
            using (SqliteTransaction treesTransaction = db.BeginTransaction())
            {
                ...
                for (int index = 0; index < tree_list.Count; ++index)
                {
                    ...
                    insertTree.Parameters[2].Value = t.position().X + offset.X;
                    insertTree.Parameters[3].Value = t.position().Y + offset.Y;
                    ...
                    insertTree.Parameters[11].Value = t.biomassFoliage();
                    insertTree.Parameters[12].Value = t.biomassStem();
                    insertTree.Parameters[13].Value = t.biomassFineRoot();
                    insertTree.Parameters[14].Value = t.biomassCoarseRoot();
                    insertTree.Parameters[15].Value = t.mNPPReserve;
                    insertTree.Parameters[16].Value = t.mStressIndex;
            ...
            if (GlobalSettings.instance().model().settings().regenerationEnabled)
            {
                using (SqliteTransaction saplingTransaction = db.BeginTransaction())
                {
                    ...
                    for (SaplingCell sc = scr.next(); sc != null; sc = scr.next())
                    {
        ...
        public bool loadStandSnapshot(int stand_id, MapGrid stand_grid, string file_name)
        {
            ...
            // load from database
            RectangleF extent = GlobalSettings.instance().model().extent();
            ...
            for (; treeReader.HasRows; treeReader.Read(), ++n)
            {
                ...
                Tree t = ru.newTree();
                t.setRU(ru);
                t.mId = treeReader.GetInt32(1);
                t.setPosition(coord);
                Species s = GlobalSettings.instance().model().speciesSet().species(treeReader.GetInt32(4));
                if (s == null)
                {
                    throw new NotSupportedException("loadTrees: Invalid species");
                }
                t.setSpecies(s);
                t.mAge = treeReader.GetInt32(5);
                t.mHeight = treeReader.GetFloat(6);
                t.mDbh = treeReader.GetFloat(7);
                t.mLeafArea = treeReader.GetFloat(8);
                t.mOpacity = treeReader.GetFloat(9);
                t.mFoliageMass = treeReader.GetFloat(10);
                t.mWoodyMass = treeReader.GetFloat(11);
                t.mFineRootMass = treeReader.GetFloat(12);
                t.mCoarseRootMass = treeReader.GetFloat(13);
                t.mNPPReserve = treeReader.GetFloat(14);
                t.mStressIndex = treeReader.GetFloat(15);
            ...
            if (GlobalSettings.instance().model().settings().regenerationEnabled)
            {
                ...
                for (; saplingReader.HasRows; saplingReader.Read())
                {
                    ...
                    SaplingCell sc = GlobalSettings.instance().model().saplings().cell(GlobalSettings.instance().model().grid().indexAt(coord), true, ref ru);
                    if (sc == null)
                    {
                        continue;
                    }
                    ...
                    if (st != null)
                    {
                        st.stress_years = saplingReader.GetByte(5);
        ...
        private void saveTrees()
        {
            ...
            using (SqliteTransaction treeTransaction = db.BeginTransaction())
            {
                ...
                for (Tree t = at.next(); t != null; t = at.next())
                {
                    ...
                    treeInsert.Parameters[2].Value = t.mPositionIndex.X;
                    treeInsert.Parameters[3].Value = t.mPositionIndex.Y;
                    ...
                    treeInsert.Parameters[10].Value = t.biomassFoliage();
                    treeInsert.Parameters[11].Value = t.biomassStem();
                    treeInsert.Parameters[12].Value = t.biomassFineRoot();
                    treeInsert.Parameters[13].Value = t.biomassCoarseRoot();
                    treeInsert.Parameters[14].Value = t.mNPPReserve;
                    treeInsert.Parameters[15].Value = t.mStressIndex;
        ...
        private void loadTrees()
        {
            ...
            foreach (ResourceUnit ruInList in GlobalSettings.instance().model().ruList())
            {
            ...
            for (; treeReader.HasRows; treeReader.Read())
            {
                ...
                Tree t = ru.newTree();
                t.setRU(ru);
                t.mId = treeReader.GetInt32(0);
                t.mPositionIndex.X = offsetx + treeReader.GetInt32(2) % Constant.cPxPerRU;
                t.mPositionIndex.Y = offsety + treeReader.GetInt32(3) % Constant.cPxPerRU;
                Species s = GlobalSettings.instance().model().speciesSet().species(treeReader.GetString(4));
                if (s == null)
                {
                    throw new NotSupportedException("loadTrees: Invalid species");
                }
            ...
            using (SqliteTransaction soilTransaction = db.BeginTransaction())
            {
                ...
                foreach (ResourceUnit ru in GlobalSettings.instance().model().ruList())
                {
                    ...
                    if (s != null)
                    {
                        ...
                        soilInsert.Parameters[9].Value = s.mYL.C;
                        soilInsert.Parameters[10].Value = s.mYL.N;
                        soilInsert.Parameters[11].Value = s.mYL.parameter();
                        soilInsert.Parameters[12].Value = s.mYR.C;
                        soilInsert.Parameters[13].Value = s.mYR.N;
                        soilInsert.Parameters[14].Value = s.mYR.parameter();
                        soilInsert.Parameters[15].Value = s.mSOM.C;
                        soilInsert.Parameters[16].Value = s.mSOM.N;
                        soilInsert.Parameters[17].Value = ru.waterCycle().currentContent();
                        soilInsert.Parameters[18].Value = ru.waterCycle().currentSnowPack();
        ...
        private void loadSoil()
        {
            ...
            for (; soilReader.HasRows; soilReader.Read())
            {
                ...
                s.mInputLab.setParameter(soilReader.GetDouble(5));
                s.mInputRef.C = soilReader.GetDouble(6);
                s.mInputRef.N = soilReader.GetDouble(7);
                s.mInputRef.setParameter(soilReader.GetDouble(8));
                s.mYL.C = soilReader.GetDouble(9);
                s.mYL.N = soilReader.GetDouble(10);
                s.mYL.setParameter(soilReader.GetDouble(11));
                s.mYR.C = soilReader.GetDouble(12);
                s.mYR.N = soilReader.GetDouble(13);
                s.mYR.setParameter(soilReader.GetDouble(14));
                s.mSOM.C = soilReader.GetDouble(15);
                s.mSOM.N = soilReader.GetDouble(16);
        ...
        private void saveSnags()
        {
            ...
            using (SqliteTransaction snagTransaction = db.BeginTransaction())
            {
                ...
                foreach (ResourceUnit ru in GlobalSettings.instance().model().ruList())
                {
                    ...
                    snagInsert.Parameters[1].Value = s.mClimateFactor;
                    ...
                    snagInsert.Parameters[9].Value = s.mTotalSWD.C;
                    snagInsert.Parameters[10].Value = s.mTotalSWD.N;
        ...
        private void loadSnags()
        {
            ...
            {
                int ci = 0;
                ru_index = snagReader.GetInt32(ci++);
                ru = mRUHash[ru_index];
                if (ru == null)
                {
                    continue;
                ...
                s.mClimateFactor = snagReader.GetDouble(ci++);
                ...
                s.mTotalSWD.C = snagReader.GetDouble(ci++);
                s.mTotalSWD.N = snagReader.GetDouble(ci++);
        ...
        private void loadSaplings()
        {
            ...
            {
                ci = 0;
                ru_index = saplingReader.GetInt32(ci++);
                ru = mRUHash[ru_index];
                if (ru == null)
                {
                    continue;
                }
                Species species = ru.speciesSet().species(saplingReader.GetString(ci++));
                if (species == null)
                {
                ...
                posx = offsetx + saplingReader.GetInt32(ci++) % Constant.cPxPerRU;
                posy = offsety + saplingReader.GetInt32(ci++) % Constant.cPxPerRU;
                ...
                st.stress_years = saplingReader.GetByte(ci++);
                ++ntotal;
        ...
        private void loadSaplingsOld()
        {
            ...
            //        Debug.WriteLine("Error when loading from saplings table...." + q.lastError().text();
            //        return;
            //    }
            //    int ru_index = -1;
            ...
            //        posx = offsetx + q.value(ci++).toInt() % Constant.cPxPerRU;
            //        posy = offsety + q.value(ci++).toInt() % Constant.cPxPerRU;
