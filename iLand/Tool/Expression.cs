    ...
    public class Expression
    {
        ...
        */
        ...
        public float Evaluate(float variable1 = 0.0F, float variable2 = 0.0F, bool forceExecution = false)
        {
            ...
            {
                if (this.linearizedDimensionCount == 1)
                {
        ...
        {
            if ((x < this.linearLow) || (x > this.linearHigh))
            {
            ...
            float result = lowerValue + valueStep * (x - (this.linearLow + lower * this.linearStep)) / this.linearStep;
            return result;
        }
