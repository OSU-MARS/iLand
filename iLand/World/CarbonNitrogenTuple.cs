namespace iLand.World
{
    ...
    public class CarbonNitrogenTuple
    {
        ...
        public float GetBiomass() { return this.C / Constant.BiomassCFraction; }
        // some simple operators
        public static CarbonNitrogenTuple operator +(CarbonNitrogenTuple tuple1, CarbonNitrogenTuple tuple2) { return new CarbonNitrogenTuple(tuple1.C + tuple2.C, tuple1.N + tuple2.N); } // return the sum of two pools
        public static CarbonNitrogenTuple operator -(CarbonNitrogenTuple tuple1, CarbonNitrogenTuple tuple2) { return new CarbonNitrogenTuple(tuple1.C - tuple2.C, tuple1.N - tuple2.N); } // return the difference of two pools
        public static CarbonNitrogenTuple operator *(CarbonNitrogenTuple tuple, float factor) { return new CarbonNitrogenTuple(tuple.C * factor, tuple.N * factor); } // return the pool multiplied with 'factor'
