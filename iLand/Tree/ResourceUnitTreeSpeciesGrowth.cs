    ...
    public class ResourceUnitTreeSpeciesGrowth
    {
        ...
        public void CalculateGppForYear(Project project)
        {
            ...
            if (this.SiteEnvironmentSaplingHeightGrowthMultiplier > 1.0F)
            {
                ...
                {
                    throw new NotSupportedException($"fEnvYear > 1 for {this.Modifiers.Species.WorldFloraID} {this.SiteEnvironmentSaplingHeightGrowthMultiplier} f_sum, epsilon, yearlyRad, refRatio {f_sum + project.Model.Ecosystem.LightUseEpsilon + this.Modifiers.TotalRadiationForYear + siteEnvironmentHeightDivisor} check calibration of the sapReferenceRatio (fref) for this species!");
                }
