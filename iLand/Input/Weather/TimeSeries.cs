...
namespace iLand.Input.Weather
{
    public class TimeSeries
    {
        ...
        protected TimeSeries(Timestep timestep, int capacityInTimesteps)
        {
            this.Capacity = capacityInTimesteps;
            this.Count = 0;
            ...
            this.Month = new int[capacityInTimesteps];
            this.Year = new int[capacityInTimesteps]; // can be shortened to one element per year if needed
        }
